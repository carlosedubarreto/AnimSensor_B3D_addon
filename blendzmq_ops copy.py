    ...
    def timed_msg_poller(self):  # context
        ...
        if socket_sub:
            ...
            if socket_sub in sockets:
                ...
                # move_val = float(msg.decode('utf-8')) * .1

                sensor_nmbr = 0
                # sensor_nmbr = percent_render_var
                # move_val_x = float(sensorDatajson[sensor_nmbr][0]) * percent_render_var
                # move_val_y = float(sensorDatajson[sensor_nmbr][1]) * percent_render_var
                # move_val_z = float(sensorDatajson[sensor_nmbr][2]) * percent_render_var
